...
class WiFiAnalyzerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("WiFi Analyzer - Wifalyzer")
        self.root.geometry("1000x700")
        self.networks = []
        self.dark_mode = True  # Start in dark mode

        # Apply Modern Theme
        self.style = Style("darkly")  # Initial theme: darkly
        self.root.configure(bg="#1c1c1c")  # Thicker dark background
    ...
    def exit_tool(self):
        """Interactive Exit Tool Button."""
        if messagebox.askyesno("Exit", "Are you sure you want to exit Wifalyzer?"):
            self.root.destroy()
